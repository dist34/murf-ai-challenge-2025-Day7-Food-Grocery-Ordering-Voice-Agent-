...
def seed_database():
    ...
    if cur.fetchone()[0] == 0:
        sample_data = [
            (
                "John", "3456", "4242",
                "INC Industry", "$500.00", "2:30 AM EST", "drip.com",
                "pending_review", "Automated flag: High value transaction."
            ),
            (
                "Sarah", "99887", "1199",
                "hammo Crypto Exchange", "$2,100.00", "4:15 AM PST", "online_transfer",
...
class FraudAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Alex', a Fraud Detection Specialist at IB Bank.
